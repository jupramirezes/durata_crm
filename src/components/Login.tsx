      ...
      <div className="w-full max-w-[420px] animate-scale-in">
        ...
        <div className="text-center mb-10">
          <div className="flex items-baseline justify-center gap-2">
            <span className="text-[32px] font-extrabold text-white tracking-tight">DURATA</span>
            <span className="text-[32px] font-extrabold text-[var(--color-primary)]">CRM</span>
          </div>
          <p className="text-[11px] text-slate-500 mt-1.5 tracking-wider font-medium">Sistema de Cotizacion</p>
        </div>

        {/* Card */}
        <form onSubmit={handleLogin} className="bg-white/[0.05] backdrop-blur-xl rounded-[20px] p-10 shadow-2xl border border-white/[0.08]">
          <h2 className="text-white font-bold text-xl mb-8 tracking-tight">Iniciar sesion</h2>

          <label className="block text-[13px] text-slate-400 mb-2 font-medium">Correo electronico</label>
          <input
            type="email"
            value={email}
          ...
          <label className="block text-[13px] text-slate-400 mb-2 font-medium">Contrasena</label>
          <input
            type="password"
            value={password}
